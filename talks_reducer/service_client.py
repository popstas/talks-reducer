...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default="h264",
        help=(
            "Select the video encoder used for the render (default: h264 — "
            "about 10%% faster and widely compatible). Switch to hevc (h.265, "
            "roughly 25%% smaller files) or av1 (no advantages) when you want "
            "different trade-offs, or mp3 to export an audio-only file."
        ),
    )
    parser.add_argument(
