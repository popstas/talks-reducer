...
- **Silent** and **Sounded** speed each offer four preset buttons (silent: 1, 2, 5, 10; sounded:
  ...
  to commit, or press Escape/click away to cancel. A committed value keeps its input box, so you
  can adjust it without reopening the editor; clicking any preset button resets the slot back
  to **…**.
